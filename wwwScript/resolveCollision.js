function resolveCollision(circle1, circle2) {
  ...
  var n = circle1.center.minus(circle2.center).normalize();
  ...
  var v1dash = circle1.moveVector.minus(n.times(optimizedP * circle2.mass));

  // Calculate v1', the new movement vector of circle1
  // v2' = v2 + optimizedP * m1 * n
  var v2dash = circle2.moveVector.add(n.times(optimizedP * circle1.mass));
